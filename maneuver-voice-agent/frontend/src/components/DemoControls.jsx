...
const VISUAL_BUTTONS = [
  ...
  ['AI Readiness', { type: 'service_detail', service: 'ai-readiness' }],
  ['Voice AI', { type: 'service_detail', service: 'voice-ai' }],
  ['Freight', { type: 'case_study', client: 'freight-brokerage' }],
  ['Hospitality', { type: 'case_study', client: 'hospitality-group' }],
  ['Industrial', { type: 'case_study', client: 'industrial-supplier' }],
  ['Reset', null],
  [
    'End Screen',
    {
      ...
      leadData: {
        ...
        company: 'Acme Inc',
        role: 'CEO',
        problem: 'Need AI automation for ops',
        timeline: 'Q3 2026',
